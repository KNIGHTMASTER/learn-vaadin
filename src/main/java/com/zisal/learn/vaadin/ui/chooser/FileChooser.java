package com.zisal.learn.vaadin.ui.chooser;
...
public class FileChooser extends VerticalLayout implements Tree.ExpandListener {
    ...
    private static final long serialVersionUID = -2559803490155791124L;
    ...
    public FileChooser(String instanceRoot, String caption, Boolean folder){
        ...
        tree.addListener( new ItemClickListener() {
            private static final long serialVersionUID = 3585507140998428036L;
     ...
     */
    @Override
    public void nodeExpand(ExpandEvent expandEvent) {
        final Item i = tree.getItem(expandEvent.getItemId());

        if (!tree.hasChildren(i)) {
            // populate tree's node which was expanded
            populateNode(expandEvent.getItemId().toString(), expandEvent.getItemId());
        }
    }
